...
// import { useNavigate } from "react-router-dom";
// import LoginDrawer from "../../drawer/LoginDrawer";
// import BackgroundSection from "../../common/BackgroundImage";
...
//         }}
//       > */}
//       <BackgroundSection bgImage="/banner4.jpeg" height="630px">
//         {/* HEADER */}
//         <header
//           className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
//             isScrolled ? "bg-black" : "bg-transparent translate-y-2"
...
//           <AnimatedTagline />
//         </div> */}
//         <div className="absolute inset-0 flex items-end justify-center pb-10 text-white text-center px-6">
//           <div className="flex flex-col sm:flex-row gap-4">
//             <Button
//               onClick={() => navigate("/services")}
//               className="px-6 py-3 rounded-2xl border-2 bg-[#00CED1]  hover:bg-white/20 transition font-semibold text-black shadow-md"
...
//               className="px-6 py-3 rounded-2xl bg-[#00CED1] border-2  text-black font-semibold shadow-lg hover:scale-[1.02] transition transform"
